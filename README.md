...
Данная команда создает каталог с именем sharedproject.git c правами на запись в него.
...
Самый простой вариант это git log с разными ключами (смотрим help). Тут приведу просто примеры. Подробнее в мануале.
...
С этой командой надо быть особо осторожным.
